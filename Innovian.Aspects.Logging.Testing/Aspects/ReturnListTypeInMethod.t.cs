    ...
    internal class ReturnListTypeInMethod
    {
        public List<int> DoSomething()
        {
            ...
            try
            {
                ...
                if (guard.CanLog)
                    global::Microsoft.Extensions.Logging.LoggerExtensions.LogInformation(_logger, $"ReturnListTypeInMethod.DoSomething() succeeded and returned an IEnumerable or IEnumerable-derived value'");
